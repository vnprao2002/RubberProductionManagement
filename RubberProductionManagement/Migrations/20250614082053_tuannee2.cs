...
{
    /// <inheritdoc />
    public partial class tuannee2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MinYield = table.Column<double>(type: "double", nullable: false),
                    MaxYield = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LotCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LotName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Area = table.Column<double>(type: "double", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RubberLots", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SessionCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTrees = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalProduction = table.Column<double>(type: "double", nullable: false),
                    TotalArea = table.Column<double>(type: "double", nullable: false),
                    Yield = table.Column<double>(type: "double", nullable: false),
                    Price = table.Column<double>(type: "double", nullable: false),
                    TotalSalary = table.Column<double>(type: "double", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Salaries_WorkSessions_WorkSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkSessionId = table.Column<int>(type: "int", nullable: false),
                    RubberLotId = table.Column<int>(type: "int", nullable: false),
                    AssignedArea = table.Column<double>(type: "double", nullable: false),
                    PlannedProduction = table.Column<double>(type: "double", nullable: false),
                    ...
                    TappingTimes = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WorkAssignments_RubberLots_RubberLotId",
                        column: x => x.RubberLotId,
                        principalTable: "RubberLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkAssignments_WorkSessions_WorkSessionId",
                        column: x => x.WorkSessionId,
                        principalTable: "WorkSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreesTapped = table.Column<int>(type: "int", nullable: false),
                    AreaWorked = table.Column<double>(type: "double", nullable: false),
                    TappingTimes = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyProductions_WorkAssignments_WorkAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyProductions_WorkAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Salaries_WorkSessionId",
                table: "Salaries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkAssignments_RubberLotId",
                table: "WorkAssignments",
                column: "RubberLotId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkAssignments_WorkSessionId",
                table: "WorkAssignments",
                column: "WorkSessionId");
        }
